package lk.chandrika_stores;

import lk.chandrika_stores.asset.common_asset.model.enums.CivilStatus;
import lk.chandrika_stores.asset.common_asset.model.enums.Gender;
...
import lk.chandrika_stores.asset.user_management.role.service.RoleService;
...
public class ApplicationCreateRestController {
    ...
    public String saveUser() {
        // roles list start
        String[] roles = { "ADMIN", "PROCUREMENT_MANAGER", "CASHIER", "MANAGER", "HR_MANAGER", "ACCOUNTANT" };
        for (String s : roles) {
            Role role = new Role();
            role.setRoleName(s);
