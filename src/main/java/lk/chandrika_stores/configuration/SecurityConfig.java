package lk.chandrika_stores.configuration;

import lk.chandrika_stores.asset.user_management.service.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    // {"ADMIN","PROCUREMENT_MANAGER","CASHIER","MANAGER","HR_MANAGER","ACCOUNTANT"}

    http.authorizeRequests(
        authorizeRequests -> authorizeRequests
            .antMatchers(ALL_PERMIT_URL).permitAll()
            .antMatchers("/category/**").hasAnyRole("ADMIN", "PROCUREMENT_MANAGER", "CASHIER", "MANAGER")
            .antMatchers("/brand/**").hasAnyRole("ADMIN", "PROCUREMENT_MANAGER", "CASHIER", "MANAGER")
            ...
            .antMatchers("/invoice/add/**").hasAnyRole("MANAGER", "PROCUREMENT_MANAGER", "CASHIER", "ADMIN")
            .anyRequest()
            .authenticated())
        // Login form
        .formLogin(
